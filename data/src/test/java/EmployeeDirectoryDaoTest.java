...
public class EmployeeDirectoryDaoTest {
    ...
    public void save() throws SQLException {
        EmployeeCard card = new EmployeeCard(1000, "New employee", "employee", "second");
        EmployeeCard card2 = new EmployeeCard(1001, "New employee2", "employee2", "three");
        EmployeeCard card3 = new EmployeeCard(1002, "New employee3", "employee3", "four");
